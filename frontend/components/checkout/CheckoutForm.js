...
function CheckoutForm() {
    ...
    async function submitOrder() {
        ...
        const reqBody  =  {
            priceId:appContext.cart.items[0].priceId,
            email:data.address
        };
        ...
        await stripe.createPaymentMethod({
            ...
            if (result.error) {
                ...
                reqBody.paymentMethodId = result.paymentMethod.id;

            }
        });
        console.log("pay method is ",reqBody.paymentMethodId);
        ...
        const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/subscriptions`, {
            ...
            body: JSON.stringify({
                ...
                vittualProducts: appContext.cart.items,
                ...reqBody
            }),
        });
